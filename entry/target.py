...
class Target():
    ...
    def target_window(self):
        ...
        lbl_static_max_HP.grid(row=1, column=0, sticky='nw')
        lbl_static_temp_HP = ttk.Label(self.stat_frame, text="Temp HP: ", font=self.reg_font)
        lbl_static_temp_HP.grid(row=2, column=0, sticky='nw')
        ...
        self.lbl_act_max_HP.grid(row=1, column=1, sticky='nw')
        self.lbl_act_temp_HP = ttk.Label(self.stat_frame, text=" ", font=self.reg_font)
        self.lbl_act_temp_HP.grid(row=2, column=1, sticky='nw')
